...
def get_top(html):
	...
	#需要匹配的REs
	p1 = re.compile(r'class="name">\w+\D+\d/\d\D+\d+\D+\d+\D+\d+\D+\d+\D+\d+\D+\d+')
...
def read_main():	 
	...
	#url
	url = "http://112.126.82.29/pubranking/week.html?scode=edupress&day=2016-11-14+%E8%87%B3+2016-11-20" #%(find_end_str,find_start_str)
	each_url = ''
	final_list_ele = ''
